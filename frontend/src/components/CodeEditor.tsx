...
export default function CodeEditor() {
  // ESKİ: const { activeFile, activeProjectId, updateFileContent } = useStore();
  // YENİ: Artık projectId'ye ihtiyacımız yok
  ...
  return (
    <div className="h-full w-full bg-[#1e1e1e]">
      <textarea
        ...
        // YENİ KULLANIM: Sadece dosya ID'si ve yeni içerik
